...
## Via Android Device
You can directly download the [APK](https://github.com/Kozarsson/Country-Guesser/releases/tag/v0.2.1) and run it locally on your own Android device or emulator of choice.
